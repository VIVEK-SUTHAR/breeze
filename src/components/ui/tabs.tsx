...
>(({ className, ...props }, ref) => (
  <div className="flex justify-center mt-2"> {/* Centering container */}
    <TabsPrimitive.List
      ref={ref}
      className={cn(
        "max-w-[450px] inline-flex h-10 items-center justify-center rounded-full bg-muted p-1 text-muted-foreground",
        className
      )}
      {...props}
    />
